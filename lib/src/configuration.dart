...
class Configuration {
  AuthOptions? get auth {
    final auth = _jsObject.auth;
    return auth == null ? null : AuthOptions._fromJsObject(auth);
  }
  ...
  CacheOptions? get cache {
    final cache = _jsObject.cache;
    return cache == null ? null : CacheOptions._fromJsObject(cache);
  }
  ...
  SystemOptions? get system {
    final system = _jsObject.system;
    return system == null ? null : SystemOptions._fromJsObject(system);
  }
  ...
  FrameworkOptions? get framework {
    final framework = _jsObject.framework;
    return framework == null ? null : FrameworkOptions._fromJsObject(framework);
  }
...
class AuthOptions {
  ...
  List<String>? get knownAuthorities {
    return jsDecodeList<String>(_jsObject.knownAuthorities);
  }
  ...
  set knownAuthorities(List<String>? value) {
    return _jsObject.knownAuthorities = jsEncode(value);
  }
  ...
  set redirectUri(dynamic value) {
    if (value is! String && value is! RedirectUriCallback) {
      throw ArgumentError.value(value, 'value',
          'The redirect URI must either be a String or a RedirectUriCallback.');
    }
...
class CacheOptions {
  CacheLocation? get cacheLocation {
    final cacheLocation = _jsObject.cacheLocation;
    return cacheLocation == null ? null : _stringToCacheLocation(cacheLocation);
  }
...
class SystemOptions {
  Logger? get logger {
    final logger = _jsObject.logger;
    return logger == null ? null : Logger._fromJsObject(logger);
  }
  ...
  SystemOptions() : _jsObject = interop.SystemOptions();
...
class FrameworkOptions {
  List<String>? get unprotectedResources {
    return jsDecodeList<String>(_jsObject.unprotectedResources);
  }
  ...
  Map<String, List<String>>? get protectedResourceMap {
    return jsDecodeMap<List<String>>(_jsObject.protectedResourceMap);
  }
  ...
  FrameworkOptions() : _jsObject = interop.FrameworkOptions();
