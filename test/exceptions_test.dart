...
void main() {
  ...
  test('ClientConfigurationError gets converted to ClientConfigurationException', () {
    expect(
  ...
  test('InteractionRequiredAuthError gets converted to InteractionRequiredAuthException', () {
    expect(
